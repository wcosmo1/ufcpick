...
/** Fighter stats keyed by display name. Camps from Tapology where available; SLpM/TDD/style remain research estimates. */
const BY_NAME: Record<string, Omit<FighterStats, "name">> = {
  ...
  "Josiah Harrell": {
    camp: "Grove City Brazilian Jiu Jitsu Academy",
    slpm: 3.9,
    tdd: 70,
    td_avg: 2.5,
    style: "Wrestling",
  ...
  "Ricky Simon": {
    camp: "American Top Team Portland",
    slpm: 3.9,
    tdd: 72,
    td_avg: 4.2,
    style: "Wrestling",
  ...
  "Payton Talbott": {
    camp: "Reno Academy of Combat and fitness",
    slpm: 5.2,
    tdd: 70,
    td_avg: 0.8,
    style: "Boxing",
  ...
  "Andrey Pulyaev": {
    camp: "School of martial arts Alexander Shlemenko",
    slpm: 3.5,
    tdd: 62,
    td_avg: 2.0,
    style: "Wrestling",
  ...
  "Court McGee": {
    camp: "The Pit Elevated Fight Team",
    slpm: 3.7,
    tdd: 68,
    td_avg: 2.2,
    style: "Wrestling",
